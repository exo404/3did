...
```bash
chmod +x capture.sh
./scripts/capture.sh any captures/sepolia testSdr 2015-11-13 1
```
Analyze the recorded PCAP to extract latency statistics (requires `tshark`):
```bash
python3 analyze_latency.py ../captures/sepolia/2025-11-13/18/testSdr18_2025-11-13_run1.pcap --details --rpc-port 443 
python3 analyze_latency.py ../captures/sepolia/2025-11-13/18/testSdr18_2025-11-13_run2.pcap --details --rpc-port 443
python3 analyze_latency.py ../captures/sepolia/2025-11-13/18/testSdr18_2025-11-13_run3.pcap --details --rpc-port 443  
python3 scripts/summarize_runs.py --day 2025-11-13 --test-name testSdr18
```
