...
```bash
chmod +x capture.sh
./scripts/capture.sh any captures/sepolia/2025-11-14/15 testSdr15 2025-11-14 1
```
Analyze the recorded PCAP to extract latency statistics (requires `tshark`):
```bash
python3 analyze_latency.py ../captures/sepolia/2025-11-14/15/testSdr15_2025-11-14_run1.pcap --details --rpc-port 443 
python3 analyze_latency.py ../captures/sepolia/2025-11-14/15/testSdr15_2025-11-14_run2.pcap --details --rpc-port 443
python3 analyze_latency.py ../captures/sepolia/2025-11-14/15/testSdr15_2025-11-14_run3.pcap --details --rpc-port 443  
python3 scripts/summarize_runs.py --day 2025-11-14 --test-name testSdr15
```
